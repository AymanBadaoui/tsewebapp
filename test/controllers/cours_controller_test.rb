...
class CoursControllerTest < ActionController::TestCase
  ...
  test "should create cour" do
    assert_difference('Cour.count') do
      post :create, cour: { description: @cour.description, filiere: @cour.filiere, niveau: @cour.niveau, titre: @cour.titre }
    end
  ...
  test "should update cour" do
    patch :update, id: @cour, cour: { description: @cour.description, filiere: @cour.filiere, niveau: @cour.niveau, titre: @cour.titre }
    assert_redirected_to cour_path(assigns(:cour))
  end
